 ...
 * Main program.
 */
/** The Resources main class. */
public class Resources implements IBM {
    ...
    private static void usage() {
        System.err.println(
            "usage: Resources [-v] algorithm consumerCount iterations");
        System.exit(1);
    } // usage()
    ...
    public static void main(String[] args) {
        ...
        GetOpt options = new GetOpt("Resources", args, "v");
        int c;
