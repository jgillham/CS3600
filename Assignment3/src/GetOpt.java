...
public class GetOpt {
    ...
    /** For communicatino from nextOpt() to the caller.  When nextOpt() finds
     * an option that takes an argument, the argument value is returned here.
     */
    public String optarg;

    /** If set to false, to not print messages to System.err for unrecognized
    ...
    public static void main(String[] ignore) {
        ...
        System.err.println("--------- Testing short options");
        opts = "ab:c::";
        ...
        while ((c = opt.nextOpt()) != -1) {
            System.err.println("option " + (char)(c=='?' ? opt.optopt : c)
                + "(" + opt.optarg + ")");
        }
        ...
        System.err.println("--------- Testing long options");
        LongOption[] lopts = new LongOption[] {
            new LongOption("argless", LongOption.NO_ARG, 'x'),
            new LongOption("hasarg", LongOption.REQ_ARG, 'y'),
            new LongOption("arg", LongOption.OPT_ARG, 'z')
        };
